...
typedef struct
{
	...
	__vo uint32_t BSRR;			//GPIO Port Bit Set/Reset Register,			address offset: 0x18-0x1A
...
typedef struct
{
	...
	__vo uint32_t CFGR;         /*!< Clock Configure Register		                                            Address offset: 0x2C   	*/
} SYSCFG_RegDef_t;
...
//#define APB1PERIPHERAL_BASEADDRESS			0x40000000U
//#define APB2PERIPHERAL_BASEADDRESS			0X40010000U
//#define AHB1PERIPHERAL_BASEADDRESS			0X40020000U
//#define AHB2PERIPHERAL_BASEADDRESS			0X50000000U
//
//
//// base addresses of peripherals on AHB1 bus
//
//#define GPIOA_BASEADDRESS					(AHB1PERIPHERAL_BASEADDRESS + 0x0000)
//#define GPIOB_BASEADDRESS					(AHB1PERIPHERAL_BASEADDRESS + 0x0400)
//#define GPIOC_BASEADDRESS					(AHB1PERIPHERAL_BASEADDRESS + 0x0800)
//#define GPIOD_BASEADDRESS					(AHB1PERIPHERAL_BASEADDRESS + 0x0C00)
//#define GPIOE_BASEADDRESS					(AHB1PERIPHERAL_BASEADDRESS + 0x1000)
//#define GPIOF_BASEADDRESS					(AHB1PERIPHERAL_BASEADDRESS + 0x1400)
//#define GPIOG_BASEADDRESS					(AHB1PERIPHERAL_BASEADDRESS + 0x1800)
//#define GPIOH_BASEADDRESS					(AHB1PERIPHERAL_BASEADDRESS + 0x1C00)
//#define GPIOI_BASEADDRESS					(AHB1PERIPHERAL_BASEADDRESS + 0x2000)
//#define GPIOJ_BASEADDRESS					(AHB1PERIPHERAL_BASEADDRESS + 0x2400)
//#define GPIOK_BASEADDRESS					(AHB1PERIPHERAL_BASEADDRESS + 0x2800)
//#define CRC_BASEADDRESS						(AHB1PERIPHERAL_BASEADDRESS + 0x3000)
//#define RCC_BASEADDRESS						(AHB1PERIPHERAL_BASEADDRESS + 0x3800)
//
//
//// base addresses of peripherals on APB1 bus
//
//#define I2C1_BASEADDRESS					(APB1PERIPHERAL_BASEADDRESS + 0x5400)
//#define I2C2_BASEADDRESS					(APB1PERIPHERAL_BASEADDRESS + 0x5800)
//#define I2C3_BASEADDRESS					(APB1PERIPHERAL_BASEADDRESS + 0x5C00)
//#define USART2_BASEADDRESS					(APB1PERIPHERAL_BASEADDRESS + 0x4400)
//#define USART3_BASEADDRESS					(APB1PERIPHERAL_BASEADDRESS + 0x4800)
//#define UART4_BASEADDRESS					(APB1PERIPHERAL_BASEADDRESS + 0x4C00)
//#define UART5_BASEADDRESS					(APB1PERIPHERAL_BASEADDRESS + 0x5000)
//#define UART7_BASEADDRESS					(APB1PERIPHERAL_BASEADDRESS + 0x7800)
//#define UART8_BASEADDRESS					(APB1PERIPHERAL_BASEADDRESS + 0x7C00)
//#define SPI2_BASEADDRESS					(APB1PERIPHERAL_BASEADDRESS + 0x3800)
//#define SPI3_BASEADDRESS					(APB1PERIPHERAL_BASEADDRESS + 0x3C00)
//
//// base addresses of peripherals on APB2 bus
//
//#define EXTI_BASEADDRESS					(APB2PERIPHERAL_BASEADDRESS + 0x3C00)
//#define SPI1_BASEADDRESS					(APB2PERIPHERAL_BASEADDRESS + 0x3000)
//#define SYSCFG_BASEADDRESS        			(APB2PERIPHERAL_BASEADDRESS + 0x3800)
//#define USART1_BASEADDRESS					(APB2PERIPHERAL_BASEADDRESS + 0x1000)
//#define USART6_BASEADDRESS					(APB2PERIPHERAL_BASEADDRESS + 0x1400)
//
//
...
//	__vo uint32_t CKGATENR;      // Clock,     														Address offset: 0x90
//	__vo uint32_t DCKCFGR2;      // RCC Dedicated Clock Configuration Register,						address offset: 0x8C
//} RCC_RegDef_t;
//
//
//typedef struct
...
//	__vo uint32_t IDR;			//GPIO Port Input Data Register, 			address offset: 0x10
//	__vo uint32_t ODR;			//GPIO Port Output Data Register,			address offset: 0x14
//	__vo uint32_t BSRR[2];		//GPIO Port Bit Set/Reset Register,			address offset: 0x18-0x1A
//	__vo uint32_t LCKR;			//GPIO Port Configuration Lock Register,	address offset: 0x1C
//	__vo uint32_t AFR[2];		//GPIO Port Alternate Function Register,	address offset: 0x20-0x24
//} GPIO_RegDef_t;
//
...
//#define USART1								((USART_RegDef_t*)USART1_BASEADDRESS)
//#define USART2								((USART_RegDef_t*)USART2_BASEADDRESS)
//#define USART3								((USART_RegDef_t*)USART3_BASEADDRESS)
//#define UART4								((USART_RegDef_t*)UART4_BASEADDRESS)
//#define UART5								((USART_RegDef_t*)UART5_BASEADDRESS)
//#define USART6								((USART_RegDef_t*)USART6_BASEADDRESS)
//#define UART7								((USART_RegDef_t*)UART7_BASEADDRESS)
//#define UART8								((USART_RegDef_t*)UART8_BASEADDRESS)
//
//
////Clock Enable Macros for GPIOx peripherals
//
...
//#define SPI4_PCLK_EN() 						(RCC->APB2ENR |= (1 << 13))
//
////Clock Enable Macros for UARTx/USARTx peripheral
//
//#define USART1_PCLK_EN()					(RCC->APB2ENR |= (1<<4))
//#define USART2_PCLK_EN()					(RCC->APB1ENR |= (1<<17))
