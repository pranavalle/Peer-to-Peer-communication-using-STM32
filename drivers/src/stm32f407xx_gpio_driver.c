 ...
 *
 * @brief					- This function enables or disables peripheral clock for the GOPI report
 *
...
void GPIO_Init(GPIO_Handle_t *pGPIOHandle)
{
	 ...
	 * @fn						- GPIO_DeInit
	 *
	 * @brief					- This function de-initializes a GPIO port by resetting registers
	 *
	 * @param[in]				- GPIO handle
	 * @param[in]				-
	 * @param[in]				-
 ...
 *
 * @brief					- This function toggles a pin in a GPIO port
 *
 * @param[in]				- GPIO port
 * @param[in]				- Pin number
 * @param[in]				-
 ...
 *
 * @brief					- This function configures an IRQ
 *
 * @param[in]				- IRQ number
